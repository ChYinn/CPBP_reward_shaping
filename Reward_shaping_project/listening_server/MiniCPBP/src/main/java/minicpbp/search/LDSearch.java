...
//         onSolution(() -> obj.tighten());
        onSolution(() -> {
            //totalTime += statistics.timeElapsed();
            String stat_message = "";
            stat_message += "fails:"+Integer.toString(statistics.numberOfFailures());
            stat_message+=",";
            stat_message += "choices:"+Integer.toString(statistics.numberOfNodes());
            stat_message+=",";
            stat_message += "time:"+Long.toString(statistics.timeElapsed());
            System.out.println(stat_message);
		try {
			File file = new File("./src/main/java/minicpbp/examples/data/ClassicalAIplanning/statistics.txt");
			if (!file.exists()) {
				file.createNewFile();
			}
			FileWriter fw = new FileWriter(file);
			BufferedWriter bw = new BufferedWriter(fw);
			bw.write(stat_message);
			bw.flush();
			bw.close();
		} catch (Exception e) {
		}
